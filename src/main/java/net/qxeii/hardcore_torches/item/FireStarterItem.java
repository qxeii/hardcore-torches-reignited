...
public class FireStarterItem extends Item {
		...
		if (attempt) {
			...
			if (simulateFlintAndSteel) {
				...
				serverWorld.spawnParticles(ParticleTypes.SMOKE, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
						10, 0.25f, 0.25f, 0.25f, 0.001f);
				serverWorld.spawnParticles(ParticleTypes.SMALL_FLAME, pos.getX() + 0.5, pos.getY() + 0.5,
						pos.getZ() + 0.5, 4, 0.25f, 0.25f, 0.25f, 0.001f);
				serverWorld.spawnParticles(ParticleTypes.LAVA, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, 2,
						0.25f, 0.25f, 0.25f, 0.001f);
				serverWorld.spawnParticles(ParticleTypes.FLAME, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, 4,
						0.25f, 0.25f, 0.25f, 0.001f);
			} else {
	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
		...
		world.playSound(null, user.getBlockPos(), SoundEvents.ITEM_CROSSBOW_LOADING_START, SoundCategory.BLOCKS, 1f,
				0f);
