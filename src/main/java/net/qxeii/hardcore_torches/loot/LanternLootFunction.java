...
public class LanternLootFunction extends ConditionalLootFunction {
    ...
    protected ItemStack process(ItemStack stack, LootContext context) {
        ...
        if (block instanceof AbstractHardcoreTorchBlock || block instanceof AbstractLanternBlock || block instanceof AbstractGlowstoneBlock || block instanceof AbstractShroomlightBlock) {
